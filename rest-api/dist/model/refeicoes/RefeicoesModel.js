...
module.exports = function () {
    function RefeicoesModel() {
        _classCallCheck(this, RefeicoesModel);
    }

    _createClass(RefeicoesModel, null, [{
        key: "getTodos",
        ...
        key: "adicionar",
        value: function adicionar(refeicoes, callback) {
            return db.query("INSERT INTO ref_refeicoes (REF_NOME) VALUES(?)", [refeicoes.REF_NOME], callback);
        }
    }, {
        key: "adicionarRelacao",
        value: function adicionarRelacao(relacao, callback) {
            return db.query("INSERT INTO rar_relacao_alimento_refeicao (RAR_REF_REFEICOES_ID, RAR_ALI_ALIMENTOS_ID) VALUES(?, ?)", [relacao.RAR_REF_REFEICOES_ID, relacao.RAR_ALI_ALIMENTOS_ID], callback);
        }
    }, {
        key: "deletar",
